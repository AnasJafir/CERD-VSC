...
const content = `import { useLocalSearchParams, useRouter } from 'expo-router';
...
export default function E7RechercheScreen() {
  ...
  const results = useMemo(() => {
    const filters: SearchFilters = {
      ...
      themeId: selectedTheme ? TAXONOMY.themes.find(t => t.code === selectedTheme)?.code : undefined, // themeId usually matches code or we map it
...
console.log('e7-recherche patched!');
