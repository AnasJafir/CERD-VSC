    ...
    <AppScreen  title="Explorateur de Domaines" subtitle="Naviguez au travers de l'arborescence complète de la Base B3D.">
      ...
      <View style={{ marginTop: 8, paddingBottom: 40 }}>
        {TAXONOMY.domaines.map((domain, dIndex) => {
          ...
          const domainThemes = TAXONOMY.themes.filter(t => t.type_parent.toLowerCase() === 'domaine' && t.parent_ref === domain.code);
              ...
              <View style={styles.accordionContainer}>
                ...
                {isDomainExpanded && (
                  <View style={styles.accordionContent}>
                    {sectors.length === 0 && domainThemes.length === 0 && <Text style={styles.emptyText}>Aucun élément défini.</Text>}
                    
                    {domainThemes.map(theme => renderTheme(theme, 1))}
